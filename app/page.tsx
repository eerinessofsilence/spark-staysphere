      ...
      <main id="main">
        ...
        <section className="mx-auto max-w-[1400px] pt-3 sm:px-6 sm:pt-8 lg:pt-14">
          {/* What the place is before what it looks like: the name, its
              classification and where it stands, above the building. The
              stars are ink, not the accent — rule 6 keeps the accent for a
              few jobs, and a rating is a fact, not an action. One image with
              one label, so a screen reader hears "5-star hotel", not five
              unnamed marks. */}
