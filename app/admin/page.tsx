          ...
          <div className="mt-5 flex flex-col items-center gap-3 rounded-[28px] border border-dashed border-border bg-card p-10 text-center">
            ...
            <div>
              ...
              <p className="mx-auto mt-2 max-w-md text-sm text-muted-foreground">
                Complete a demo booking on the guest site and it appears here, on the Property Desk, and in
                Reservations.
              </p>
            </div>
...
function Sparkline({ days, totalRooms }: { days: ChessboardDay[]; totalRooms: number }) {
  return (
