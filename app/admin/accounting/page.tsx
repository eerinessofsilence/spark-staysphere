    ...
    <AdminPage>
      ...
      <section aria-labelledby="ledger-heading" className="mt-12">
        ...
        <p className="mt-2 text-sm text-muted-foreground">
          Every booking and what became of its payment, newest first.
        </p>
        <div className="mt-5">
          {ledger.rows.length === 0 ? (
            <div className="flex flex-col items-center rounded-[18px] bg-card px-6 py-10 text-center shadow-soft">
              ...
              <p className="mt-1 max-w-md text-sm text-muted-foreground">
                Payments from bookings show up here as they come in.
              </p>
            ...
            <TableCard caption="Bookings and their payment state" className="min-w-[48rem]">
              <thead>
                <tr className="border-b border-border">
                  <Th>Booked</Th>
