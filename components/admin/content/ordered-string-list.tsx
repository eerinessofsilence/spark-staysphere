    ...
    <div className="grid gap-2">
        ...
        <ul className="grid gap-2">
          {items.map((item, index) => {
            ...
            <li key={index} className="flex items-center gap-2">
              {RowIcon ? (
                <span className="grid size-9 shrink-0 place-items-center rounded-full bg-stone text-foreground">
      ...
      <div className="flex items-center gap-2">
        <TextInput
          ...
          className="flex-1"
        />
        <button type="button" onClick={add} aria-label="Add" className={iconButton('dark', 'size-9')}>
